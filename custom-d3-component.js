...
const statesToValiues = {Washington:{min:6, def:10, max:14, step: 4}, NorthCarolina:{min:9, def:13, max:17, step: 4}}
...
// change triggered by stacktrace slider
 // const svg = myTotalSVG
 //      var currnentLines = svg.selectAll("line")._groups[0];
 //      var limitingFactor = props.stackLookingInto - 1
 //      for (var i = allMyLines.length - 1; i >= 0; i--) {
 //        console.log(allMyLines[i]._groups[0][0])
 //        if(allMyLines[limitingFactor]._groups[0][0] == currnentLines[i]){
 //          allMyLines[i]._groups[0][0].setAttribute('stroke', "orange")
 //        } else{
 //        allMyLines[i]._groups[0][0].setAttribute('stroke', "black")

 //        }
 //      }
 //      for (var i = limitingFactor - 1; i >= 0; i--) {
 //          for(var j = currnentLines.length - 1; j >= 0; j--){
 //            if(allMyLines[i]._groups[0][0] == currnentLines[j]){
 //              allMyLines[i]._groups[0][0].setAttribute('stroke', "yellow")
 //            }
 //          }
 //      }
      return
    ...
    .attr("style","fill:white;stroke:black;stroke-width:1"))
     ...
     console.log("debug")
          ...
          var shouldChange = statesToValiues[stateNameLocal]['def'] 
